...
//     const newScrollLeft = scrollRow.scrollLeft + (direction === 'left' ? -scrollAmount : scrollAmount);
...
//         .document-slider-root:hover .nav-arrow.visible {
//           opacity: 1;
//         }
...
const DocumentSlider = () => {
 ...
 const slides = [
  ...
  const scroll = useCallback((direction) => {
    ...
    const target = direction === "left" ? scrollRow.scrollLeft - scrollAmount : scrollRow.scrollLeft + scrollAmount;
