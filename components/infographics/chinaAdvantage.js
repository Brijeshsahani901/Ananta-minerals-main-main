        ...
        <div className="row g-3">
          ...
          <div className="col-12 col-lg-8">
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              {/* ---------- TOP CARD ---------- */}
              <div style={{ ...card }}>
                <div  className={montserrat.className}  style={{ fontSize: 15, fontWeight: 800,lineHeight: 1.1 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                  ...
                  <div className="mt-1" style={{ flex: 1, minWidth: 260}}>
                    <ul  className={montserrat.className}  style={{ margin: 0, paddingLeft: 20, fontSize: 12.5, lineHeight: 1.55 }}>
                      <li>
                        Globally, electric 2W/3W and most buses favor LFP—safer, cheaper,
                        heat-tolerant. Nickel-based (NMC) powers higher-range models.
                      </li>
                      <li  className={montserrat.className}  style={{ marginTop: 8 }}>
                    ...
                    {[
                      ...
                      return (
                        <div key={b.year} style={{ textAlign: "center" }}>
                          ...
                          <div  className={montserrat.className}  style={{ fontSize: 11.5, marginTop: 5 }}>{b.year}</div>
                        </div>
                      );
                    })}
                  </div>
              ...
              >
                ...
                <div className={montserrat.className}  style={{ height: 120 }}>
          ...
          <div className="col-12 col-lg-4">
            <div  className={montserrat.className} style={{ ...card, display: "flex", flexDirection: "column", gap: 14 }}>

              <div className={montserrat.className}  style={{ fontSize: 11.5, lineHeight: 1.45 }}>
...
<div style={{ position: "relative", width: "100%", height: 160 }}>
  ...
  <Bar  className={montserrat.className} 
    data={barData}
    options={{
      ...barOptions,
      plugins: {
  ...
  />
              ...
              <div>
                <div  className={montserrat.className}  style={{ fontSize: 15, fontWeight: 800, marginBottom: 4, lineHeight: 1.1 }}>
                  India’s Economic & Policy Measures
                </div>

                <ul  className={montserrat.className}  style={{ paddingLeft: 18, margin: 0, fontSize: 11.3, lineHeight: 1.41 }}>
                  <li>
                    India is emerging as Asia’s new critical-mineral hub, using NCMM, duty
                    waivers, mining royalty reforms & policy incentives.
                  </li>
                  <li  className={montserrat.className}  style={{ marginTop: 4 }}>
